...
public class MyExpandableListViewAdapter_size extends BaseExpandableListAdapter {
    ...
    public MyExpandableListViewAdapter_size(Context context, List<String> groupList,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
        ...
        if (isExpanded) {
            ...
            groupHolder.groupImg.setImageResource(R.drawable.size_click);
        } else {
            groupHolder.sanjiao.setImageResource(R.drawable.sanjiao);
            groupHolder.groupImg.setImageResource(R.drawable.size);
        }

...
public class MyAdapter_Person_handler_forSign extends BaseAdapter {
    private List<Model> data;
    private Context context;
    private getSignInfo_handler.AllCheckListener allCheckListener;
    private List<personName> personName = new ArrayList<>();


    public MyAdapter_Person_handler_forSign(List<Model> data, Context context, getSignInfo_handler.AllCheckListener allCheckListener) {
        this.data = data;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.person_item_list_forsign, null);
            ...
            hd.textView3 = view.findViewById(R.id.signtime);
            hd.textView4 = view.findViewById(R.id.status);
        ...
        hd.textView3.setText(mModel.getTime());
        hd.textView4.setText(mModel.getStatue());

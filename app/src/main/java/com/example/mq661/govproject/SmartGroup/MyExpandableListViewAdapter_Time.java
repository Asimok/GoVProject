...
public class MyExpandableListViewAdapter_Time extends BaseExpandableListAdapter {
    ...
    public MyExpandableListViewAdapter_Time(Context context, List<String> groupList,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
        ...
        if (isExpanded) {
            ...
            groupHolder.groupImg.setImageResource(R.drawable.time_click);
        } else {
            groupHolder.sanjiao.setImageResource(R.drawable.sanjiao);
            groupHolder.groupImg.setImageResource(R.drawable.time);
        }

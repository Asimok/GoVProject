...
public class MyAdapter_Person_handler_forAfterPayment extends BaseAdapter {
    private List<Model> data;
    private Context context;
    private addPerson_handler_forAfterPayment.AllCheckListener allCheckListener;
    private List<personName> personName = new ArrayList<>();


    public MyAdapter_Person_handler_forAfterPayment(List<Model> data, Context context, addPerson_handler_forAfterPayment.AllCheckListener allCheckListener) {
        this.data = data;

...
public class MyExpandableListViewAdapter_Days extends BaseExpandableListAdapter {
    ...
    public MyExpandableListViewAdapter_Days(Context context, List<String> groupList,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
        ...
        if (isExpanded) {
            ...
            groupHolder.groupImg.setImageResource(R.drawable.date_click);
        } else {
            groupHolder.sanjiao.setImageResource(R.drawable.sanjiao);
            groupHolder.groupImg.setImageResource(R.drawable.date);
        }

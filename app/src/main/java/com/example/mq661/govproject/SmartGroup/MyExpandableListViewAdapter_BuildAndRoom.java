...
public class MyExpandableListViewAdapter_BuildAndRoom extends BaseExpandableListAdapter {
    ...
    public MyExpandableListViewAdapter_BuildAndRoom(Context context, List<String> groupList,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
        ...
        if (isExpanded) {
            ...
            groupHolder.groupImg.setImageResource(R.drawable.build_click);
        } else {
            groupHolder.sanjiao.setImageResource(R.drawable.sanjiao);
            groupHolder.groupImg.setImageResource(R.drawable.build);
        }

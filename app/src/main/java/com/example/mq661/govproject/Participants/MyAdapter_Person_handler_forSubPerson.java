...
public class MyAdapter_Person_handler_forSubPerson extends BaseAdapter {
    private List<Model> data;
    private Context context;
    private subPerson_handler.AllCheckListener allCheckListener;
    private List<personName> personName = new ArrayList<>();


    public MyAdapter_Person_handler_forSubPerson(List<Model> data, Context context, subPerson_handler.AllCheckListener allCheckListener) {
        this.data = data;
    ...
    private void removeName(String name, String num) {
        ...
        Log.d("aa", "del里   " + subPerson_handler.personName1.size());
        for (int i = subPerson_handler.personName1.size() - 1; i >= 0; i--) {
            Log.d("aa", "del里   " + subPerson_handler.personName1.get(i).getNum());
            String value = subPerson_handler.personName1.get(i).getName();
            String num1 = subPerson_handler.personName1.get(i).getNum();
            if (value.equals(name) && num1.equals(num)) {
                subPerson_handler.personName1.remove(i);
